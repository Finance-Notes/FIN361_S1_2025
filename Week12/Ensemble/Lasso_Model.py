...
class LassoForecastingEngine:
    ...
    def forecast_single_stock(self, features: pd.DataFrame, targets: pd.Series,
        ...
        for window_end in range(self.min_window_size, n_obs):
            ...
            try:
                ...
                # Fit final model
                final_model = LassoLars(alpha=optimal_alpha, max_iter=1000)
    ...
    def save_detailed_forecasts(self, results: dict, filename: str = 'outputs/detailed_lasso_forecasts.csv') -> pd.DataFrame:
        """
